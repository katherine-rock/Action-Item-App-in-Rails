...
class ActionItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create action_item" do
    assert_difference('ActionItem.count') do
      post action_items_url, params: { action_item: { action: @action_item.action, category: @action_item.category, comment: @action_item.comment, priority: @action_item.priority } }
    end
  ...
  test "should update action_item" do
    patch action_item_url(@action_item), params: { action_item: { action: @action_item.action, category: @action_item.category, comment: @action_item.comment, priority: @action_item.priority } }
